...
export function Footer() {
  return (
    <footer className="bg-[#16312a] text-white">
      <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
        <div className="grid gap-10 md:grid-cols-[1.2fr_0.8fr_0.8fr_1fr]">
          ...
          <div>
            ...
            <div className="mt-4 grid gap-2 text-sm text-[#c9ddd4]">
          ...
          <div>
            ...
            <div className="mt-4 grid gap-3 text-sm text-[#c9ddd4]">
        ...
        <div className="mt-10 border-t border-white/12 pt-5 text-sm text-[#c9ddd4]">
